...
namespace Lab_rab_4_1_Safin_R._R._23_02.ViewModel
{
    public class PersonViewModel : INotifyPropertyChanged
    {
        ...
        {
            ObservableCollection<PersonDpo> tempList = new ObservableCollection<PersonDpo>();
                ...
                return editPerson ??
                    (editPerson = new RelayCommand(obj =>
                    {
                        ...
                        if (wnPerson.ShowDialog() == true)
                        {
                            ...
                            ListPerson[index] = p.CopyFromPersonDPO(personDpo);
                        }
                ...
                return deletePerson ??
                    (deletePerson = new RelayCommand(obj =>
                    {
                        ...
                        if (result == MessageBoxResult.OK)
                        {
                            ...
                            FindPerson finder = new FindPerson(per.Id);
                            List<Person> listPerson = ListPerson.ToList();
                            Person p = listPerson.Find(new Predicate<Person>(finder.PersonPredicate));
                            ListPerson.Remove(p);
                        }
